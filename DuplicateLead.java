...
public class DuplicateLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(500);
		WebElement leadno = driver.findElement(By.xpath("//div[@class='x-grid3-cell-inner x-grid3-col-partyId']/a"));
		String text2 = leadno.getText();
		System.out.println(text2);
		leadno.click();
		//driver.findElement(By.linkText("10408")).click();
